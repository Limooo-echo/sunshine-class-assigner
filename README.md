# 🌞 Sunshine Class Division Assigner (阳光分班系统)
...
```text
Sunshine-Class-Division/
├── Sunshine.py         # 核心主程序：执行分班逻辑，生成分班结果
├── Analysis.py         # 统计工具：读取分班结果，生成多维分析报表
├── data/               # (建议) 存放你的源数据 Excel
├── README.md           # 项目说明文档
...
运行 `Analysis.py` 后，你将看到类似以下的统计结果，用于汇报和公示：

| 班级 | 男生 | 女生 | 总人数 | 平均分 | 城区 | 乡下 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1    | 25   | 24   | 49     | 148.9  | 38   | 11   |
| 2    | 24   | 25   | 49     | 149.3  | 38   | 11   |
| ...  | ...  | ...  | ...    | ...    | ...  | ...  |
| **平均** | **24.8** | **24.1** | **48.9** | **148.9** | **37.9** | **10.9** |
